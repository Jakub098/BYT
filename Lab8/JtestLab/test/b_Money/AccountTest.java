...
public class AccountTest {
	...
	public void testTimedPayment() throws AccountDoesNotExistException {
		testAccount.addTimedPayment("1", 1, 2, new Money(1, SEK), SweBank, "Alice"); 
		System.out.println(testAccount.getBalance().getAmount());
		testAccount.tick();
		testAccount.tick();
		assertEquals(new Integer(10000000 - 150 - 1), testAccount.getBalance().getAmount(), 0);
	}

	@Test
	public void testAddWithdraw() {
		testAccount.deposit(new Money(5000, SEK));
		assertEquals(10000000 - 150 + 5000, testAccount.getBalance().getAmount(), 0);  
	...
	public void testGetBalance() {
		assertTrue(new Money(10000000 - 150, SEK).equals(testAccount.getBalance()));
	}
}
