...
public class Account {
	private String accountName; //created for testing
	...
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Bank tobank, String toaccount) {
		//case when timed payment already exists "handled" 
	...
	public void removeTimedPayment(String id) {
		//case when timed payment doesn't exist "handled" 
		if (timedPaymentExists(id)) {
...
//			tp.tick(); tp.tick(); //test_error
	 ...
	 */
	public Integer getBalance() {    //changed the return type from Money to integer
//		return content;
